  ...
  return (
    ...
    >
      <select
        ...
        {...props}
      />
      <ChevronDown className="pointer-events-none absolute right-2.5 top-1/2 min-w-4 -translate-y-1/2 text-muted-foreground opacity-50" aria-hidden="true" data-slot="native-select-icon" />
    </div>
  )
}
