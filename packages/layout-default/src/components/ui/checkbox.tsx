  ...
  return (
    <div className="relative inline-flex items-center">
      <input
        ...
        className={cn(
          "peer size-4 shrink-0 rounded border border-gray-300 bg-white shadow-sm transition-colors",
      ...
      <div
        className={cn(
          "flex size-4 shrink-0 items-center justify-center rounded border border-gray-300 bg-white shadow-sm transition-colors",
